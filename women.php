  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/b/bc/Myntra_Logo.png"/>
      ...
      <form action="search.php" method="get">
       <input class="search" name="str" placeholder="Search for products, brands and more" class="desktop-searchBar" value="" data-reactid="904">
        ...
        <div class="bag mx-2 fa-solid "> <i class="fa-solid fa-bag-shopping"></i>
          <span>bag</span></div>
          </div>
    ...
    <section class="container section1">
        <img class="homeImg" src="womenback21.jpg" />
    ...
    <section class="container section1 flex flex-wrap">
        ...
        <div id="category_to_Bag" class="container flex">
            <div ><img src="imagew2.png"></div>
            <div ><img src="imagew3.png"></div>

            <div ><img src="imagew1.png"></div>
            <div ><img src="watchlog.jfif">
            </div>
        </div>
</section>
        <section class="container section1 flex flex-wrap">

<div  class="container flex"><h1 class="brand_heading inc_mar">kurtas</h1></div>
<div  class="container flex categoryBag">
<?php
							$get_product=get_product($con,'',7);
...
<div  class="container flex"><h1 class="brand_heading inc_mar">sarees</h1></div>
<div  class="container flex categoryBag">
<?php
